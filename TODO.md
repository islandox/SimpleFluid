...
- [x] Test with problems with analytical solution. — Steady 1D diffusion matches linear profile; error norms (L2, Linf) added; explicit diffusion stepping verified
