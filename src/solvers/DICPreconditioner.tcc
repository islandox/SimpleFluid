...
DICPreconditioner<Pack>::DICPreconditioner(const matrix_type& matrix)
...
template<TpetraTypePack Pack>
void DICPreconditioner<Pack>::apply(
...
template<TpetraTypePack Pack>
bool DICPreconditioner<Pack>::local_map_matches(const Teuchos::RCP<const map_type>& other) const
{
...
template<TpetraTypePack Pack>
void DICPreconditioner<Pack>::require_collectively(bool valid, const char* message) const
{
...
template<TpetraTypePack Pack>
std::vector<std::vector<typename DICPreconditioner<Pack>::GlobalEntry>> DICPreconditioner<Pack>::global_rows(const matrix_type& matrix) const
{
...
template<TpetraTypePack Pack>
void DICPreconditioner<Pack>::initialize_distributed(const matrix_type& matrix)
{
...
template<TpetraTypePack Pack>
std::vector<typename DICPreconditioner<Pack>::StageTransfer> DICPreconditioner<Pack>::make_stage_transfers(
...
template<TpetraTypePack Pack>
void DICPreconditioner<Pack>::apply_distributed(const multi_vector_type& input, multi_vector_type& output,
