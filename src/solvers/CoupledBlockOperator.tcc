...
CoupledBlockOperator<Pack>::CoupledBlockOperator(Teuchos::RCP<const map_type> map, Teuchos::RCP<const matrix_type> momentum,
...
template<TpetraTypePack Pack>
void CoupledBlockOperator<Pack>::apply(const multi_vector_type& input, multi_vector_type& output, Teuchos::ETransp mode,
...
template<TpetraTypePack Pack>
void CoupledBlockOperator<Pack>::ensure_scratch(size_t columns) const
{
