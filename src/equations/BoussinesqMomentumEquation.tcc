    ...
    const velocity_field_type* correction_field) const -> system_type
{
    ...
    return assemble_system(
        old_velocity, face_fluxes, temperature, velocity_boundary_cache, options, zero_source, correction_field);
}
    ...
    const source_type& right_hand_source, const velocity_field_type* correction_field) const -> system_type
{
    ...
    return base_type::assemble_system(
        old_velocity, face_fluxes, velocity_boundary_cache, options, combined_source, correction_field);
}
    ...
    const LinearSolverOptions& linear_options) const -> LinearSolveSummary
{
    ...
    return base_type::advance_velocity(
        old_velocity, face_fluxes, velocity_boundary_cache, options, velocity, combined_source, linear_options);
}
    ...
    -> system_type
{
    ...
    return base_type::assemble_physical_system(old_velocity, face_fluxes, velocity_boundary_cache, options,
        dynamic_viscosity, reference_density, acceleration, correction_field, boundary_dynamic_viscosity);
}
    ...
    -> LinearSolveSummary
{
    ...
    return base_type::advance_velocity_physical(old_velocity, face_fluxes, velocity_boundary_cache, options,
        dynamic_viscosity, reference_density, velocity, acceleration, linear_options, boundary_dynamic_viscosity);
}
