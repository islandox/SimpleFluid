...
/**
 * @brief Library-provided transport geometry cache specialization.
 *
 * Additional mesh/type-pack combinations require a deliberate explicit
 * instantiation in the owning implementation target.
 */
